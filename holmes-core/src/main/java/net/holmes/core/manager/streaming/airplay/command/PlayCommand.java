...
package net.holmes.core.manager.streaming.airplay.command;

import static net.holmes.core.manager.streaming.airplay.command.Command.CommandType.PLAY;
import static net.holmes.core.manager.streaming.airplay.command.Command.PostParameter.CONTENT_LOCATION;
import static net.holmes.core.manager.streaming.airplay.command.Command.PostParameter.START_POSITION;
