...
import static net.holmes.core.manager.configuration.Parameter.STREAMING_STATUS_UPDATE_DELAY_SECONDS;
import static net.holmes.core.manager.streaming.session.SessionStatus.*;
