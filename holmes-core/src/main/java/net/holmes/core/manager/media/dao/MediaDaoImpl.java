...
package net.holmes.core.manager.media.dao;
...
import net.holmes.core.manager.media.dao.icecast.IcecastEntry;
import net.holmes.core.manager.media.dao.icecast.IcecastGenre;
import net.holmes.core.manager.media.dao.index.MediaIndexDao;
import net.holmes.core.manager.media.dao.index.MediaIndexElement;
...
import static net.holmes.core.manager.media.dao.index.MediaIndexElementFactory.buildConfigMediaIndexElement;
import static net.holmes.core.manager.media.model.AbstractNode.NodeType.TYPE_ICECAST_ENTRY;
import static net.holmes.core.manager.media.model.AbstractNode.NodeType.TYPE_UNKNOWN;
import static net.holmes.core.manager.media.model.RootNode.ICECAST;
