...
import net.holmes.core.manager.streaming.airplay.command.PlayCommand;
import net.holmes.core.manager.streaming.airplay.command.PlayStatusCommand;
import net.holmes.core.manager.streaming.airplay.command.RateCommand;
import net.holmes.core.manager.streaming.airplay.command.StopCommand;
