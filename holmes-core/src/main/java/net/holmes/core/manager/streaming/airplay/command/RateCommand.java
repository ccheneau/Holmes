...
import static net.holmes.core.manager.streaming.airplay.command.Command.CommandType.RATE;
import static net.holmes.core.manager.streaming.airplay.command.Command.UrlParameter.VALUE;
