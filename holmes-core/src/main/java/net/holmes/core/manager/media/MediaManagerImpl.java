...
package net.holmes.core.manager.media;
...
import net.holmes.core.manager.media.model.MimeTypeNode;
...
import static net.holmes.core.manager.media.model.RootNode.ROOT;
