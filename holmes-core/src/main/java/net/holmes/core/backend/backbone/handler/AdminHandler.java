...
@Path("/backend/backbone/admin")
public class AdminHandler {

    private final BackboneManager backboneManager;

    @Inject
    public AdminHandler(BackboneManager backboneManager) {
    ...
    public Collection<IndexElement> getMediaIndexElements() {
        return backboneManager.getMediaIndexElements();
    }

    @POST
    @Path("/scanAll")
    public void scanAllMedia() {
        backboneManager.scanAllMedia();
    }
}
