...
package net.holmes.core.manager.streaming.session;

import org.junit.Test;

import java.util.Map;

import static net.holmes.core.manager.streaming.session.SessionStatus.PLAYING;
import static net.holmes.core.manager.streaming.session.SessionStatus.WAITING;
