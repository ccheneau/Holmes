...
public class ReleaseCheckServiceTest {
    ...
    public void testReleaseCheckService() {
        ...
        expect(configurationDao.getIntParameter(RELEASE_CHECK_DELAY_HOURS)).andReturn(1);
    ...
    public void testReleaseCheckServiceNoDelay() {
        ...
        expect(configurationDao.getIntParameter(RELEASE_CHECK_DELAY_HOURS)).andReturn(0);
