var Application = (function() {
	...
	application.Router.RoutesManager = Backbone.Router.extend({
		...
		editVideoFolder : function(id_folder) {
			var videoFolder = new Application.Models.VideoFolder({
				id : id_folder
			});
			videoFolder.fetch({
		...
		editAudioFolder : function(id_folder) {
			var audioFolder = new Application.Models.AudioFolder({
				id : id_folder
			});
			audioFolder.fetch({
				success : function(result) {
		...
		editPictureFolder : function(id_folder) {
			var pictureFolder = new Application.Models.PictureFolder({
				id : id_folder
			});
			pictureFolder.fetch({
				success : function(result) {
		...
		editPodcast : function(id_folder) {
			var podcast = new Application.Models.Podcast({
				id : id_folder
			});
			podcast.fetch({
				success : function(result) {
